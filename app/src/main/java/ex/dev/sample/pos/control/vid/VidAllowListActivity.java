...
public class VidAllowListActivity extends AppCompatActivity implements VidAllowListAdapter.OnItemActionListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.root_vid), (v, insets) -> {
     ...
     */
    private void onVidEnabled(boolean isChecked) {
        try {
            ...
            vidEnabled.setChecked(!isChecked);
    ...
    private void loadEnabled() {
        try {
            boolean isVidEnabled = dataSource.isVidAllowListEnabled();
