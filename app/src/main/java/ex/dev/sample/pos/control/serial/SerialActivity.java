...
public class SerialActivity extends AppCompatActivity {
    ...
    private void bindCom1() {
        ...
        com1Panel.btnClose.setOnClickListener(v -> show(viewModel.clearCom1Port().getMessage()));
        com1Panel.btnWrite.setOnClickListener(v -> show(viewModel.writeCom1Port().getMessage()));
    ...
    private void bindCom2() {
        ...
        com2Panel.btnClose.setOnClickListener(v -> show(viewModel.clearCom2Port().getMessage()));
        com2Panel.btnWrite.setOnClickListener(v -> show(viewModel.writeCom2Port().getMessage()));
